...
extern const __u8 _ebctype_asc[256]; /* EBCDIC -> character classes */

#define __ismask_ebc_asc(x) (_ebctype_asc[(int)(unsigned char)(x)])
#define isprint_ebc_asc(c) ((__ismask_ebc_asc(c)&(_P|_U|_L|_D|_SP)) != 0)
